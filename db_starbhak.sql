...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2020 at 10:30 AM
...
(44, 'Dery', 'Cilacap', 'Laki-laki', '2019-01-01', 'Rekayasa\r\nPerangkat Lunak', 'biodata', 'avatar4.png'),
...
--
-- Table structure for table `tbl_siswa_search`
--
...
--
-- Dumping data for table `tbl_siswa_search`
--

INSERT INTO `tbl_siswa_search` (`id`, `nama_siswa`, `alamat`, `jenis_kelamin`, `tgl_masuk`, `jurusan`, `biodata`, `avatar`) VALUES
...
--
-- Indexes for table `tbl_siswa_search`
--
...
--
-- AUTO_INCREMENT for table `tbl_siswa_search`
--
ALTER TABLE `tbl_siswa_search`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
